import bee_movie from "./BeeMovieScript";

const input_data = {
  pembukaan_uud_45:{
    title:"Pembukaan UUD 1945",
    content:`Bahwa sesungguhnya Kemerdekaan itu ialah hak segala bangsa dan oleh sebab itu, maka penjajahan di atas dunia harus dihapuskan, karena tidak sesuai dengan perikemanusiaan dan perikeadilan.
  ...
  udd_1945_preamble:{
    title:"UUD 1945 Preamble",
    content:`Whereas independence is the inalienable right of all nations, therefore, all colonialism must be abolished in this world as it is not in conformity with humanity and justice;
  ...
  bee_movie_part_2:{
    title:"Bee Movie Script part 2",
    content:bee_movie.part2
  },
  bee_movie_part_3:{
    title:"Bee Movie Script part 3",
    content:bee_movie.part3
  }
  
}
// testing:{
// title:'test',
// content:`Aku punya anjing kecil
// Ayo lari-lari
// gug;
// gug!
// gug?
